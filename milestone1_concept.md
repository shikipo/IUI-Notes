...
TODO: в начале спросить аудиторию, кто знает 2 или больше языков и кто читал что либо в оригинале (книги (например, для людей у которых родной язык не английский, "Гарри Поттер" или "Властелина колец"), статьи, комиксы и т.д.) — показать, что многие сталкиваются с проблемой: хочется читать в оригинале, но постоянно нужно отвлекаться на перевод.

TODO: рассказать о смысле через уже готовые примеры (Deepl extension, которое позволяет выделить слово и получить перевод, но работы с image; Google Lens, который распознаёт текст на фото, но не позволяет сохранять в списке изучаемых слов) и показать, что мы хотим сделать что-то более seamless, без необходимости переключаться между приложениями. Смысл в том, чтобы пользователь мог просто открыть документ и читать, а при встрече с незнакомым словом — получить перевод прямо там, не отрываясь от чтения. Это должно создать более погружённый опыт и помочь учить язык в контексте, а не через отдельные приложения.  
Скачать, что главная особенность — это не просто перевод, а именно seamless experience, который позволяет сохранять фокус на чтении и погружении в текст, а не отвлекаться на переключение между приложениями. Это может быть особенно полезно для людей, которые читают сложные тексты (научные статьи, литературу) или комиксы, где визуальный контекст важен.
